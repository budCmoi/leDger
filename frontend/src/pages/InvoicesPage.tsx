  ...
  return (
    <PageTransition>
      <form className="space-y-4" onSubmit={(event) => void handleSubmit(event)}>
        <header className="rounded-[1.2rem] border border-white/10 bg-white/[0.03] px-3 py-3">
          <div className="flex flex-wrap items-start gap-3">
            <input
              className="h-10 min-w-[180px] flex-1 rounded-xl border border-white/12 bg-black/30 px-3 text-xs text-white outline-none"
              onChange={(event) => setReference(event.target.value)}
              placeholder="Reference facture"
              value={reference}
            />
            <input
              className="h-10 min-w-[220px] flex-[1.2] rounded-xl border border-white/12 bg-black/30 px-3 text-xs text-white outline-none"
              onChange={(event) => setSupplier(event.target.value)}
              placeholder="Fournisseur"
              value={supplier}
            />
            <input
              className="h-10 min-w-[160px] rounded-xl border border-white/12 bg-black/30 px-3 text-xs text-white outline-none"
        ...
        <div className="flex min-h-[calc(100vh-34rem)] items-center justify-center">
          <div className="w-full overflow-x-auto rounded-[1.2rem] border border-white/10 bg-white/[0.02]">
            <div className="min-w-[1020px]">
            <div className="grid grid-cols-[130px_1.8fr_100px_120px_100px_130px_130px] border-b border-white/10 px-3 py-2 text-[10px] uppercase tracking-[0.16em] text-white/45">
            ...
            {lines.map((line, rowIndex) => {
              ...
              return (
                <div
                  className="grid grid-cols-[130px_1.8fr_100px_120px_100px_130px_130px] items-center gap-2 border-b border-white/8 px-3 py-2"
                  key={line.id}
                >
                  <input
                    className="h-9 rounded-lg border border-white/10 bg-black/25 px-2 text-xs text-white outline-none"
                  ...
                  <input
                    className="h-9 rounded-lg border border-white/10 bg-black/20 px-2 text-xs text-white/80 outline-none"
                    readOnly
                    tabIndex={-1}
        ...
        <div className="flex items-center justify-end gap-4 rounded-[1.2rem] border border-white/10 bg-white/[0.02] px-3 py-2 text-xs uppercase tracking-[0.14em] text-white/70">
