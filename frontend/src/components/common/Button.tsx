...
export const Button = ({
  ...
  return (
    <button
      className={cn(
        'inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-sm uppercase tracking-[0.22em] transition duration-200 disabled:cursor-not-allowed disabled:opacity-50',
